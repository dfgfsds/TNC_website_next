...
import { Quote, Star, PenSquare, ExternalLink } from 'lucide-react';

// 🔗 Place your Google Form Link here:
const GOOGLE_FORM_URL = "https://g.page/r/CZ2PYn41RxkOEBM/review";
      ...
      <div className="text-center mb-10">
        ...
        <div className="mt-5">
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-purple-600 to-fuchsia-600 hover:from-purple-700 hover:to-fuchsia-700 text-white font-semibold text-sm shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0"
          >
