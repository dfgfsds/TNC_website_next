...
export default function HomeSeoSection() {
    ...
    return (
        <section className="mt-6 space-y-8">
            ...
            <div className="relative group bg-white/95 border border-purple-100/90 rounded-[2rem] p-7 sm:p-10 lg:p-12 shadow-xl shadow-purple-900/5 transition-all duration-300">
            ...
            {open && (
                <div className="space-y-10 transition-all duration-300 ease-in-out">
                    ...
                    <div className="relative bg-gradient-to-br from-purple-50/80 via-fuchsia-50/40 to-white border border-purple-100 rounded-[2rem] p-7 sm:p-10 shadow-lg shadow-purple-900/5 space-y-6">
                        ...
                        <div className="bg-white/90 rounded-2xl p-6 sm:p-7 border border-purple-100 shadow-xs space-y-4">
                            ...
                            <div className="grid gap-3.5 sm:grid-cols-2 lg:grid-cols-3">
                                {[
                                    ...
                                    >
                                        <div className="w-5 h-5 rounded-full bg-purple-600 text-white flex items-center justify-center shrink-0 text-xs">
                                            ✓
                                        </div>
                                        <span>{item}</span>
                                    </div>
                        ...
                        <div className="relative space-y-4 pt-2">
                            ...
                            <div className="grid gap-3.5 sm:grid-cols-2 lg:grid-cols-3">
                                {[
                                    ...
                                    <div
                                        key={idx}
                                        className="flex items-center gap-3 bg-white/10 hover:bg-white/15 border border-white/15 rounded-xl px-4 py-3.5 text-sm sm:text-base font-medium text-purple-50 transition-colors"
                                    >
                    ...
                    <div className="bg-gradient-to-r from-purple-50/70 via-white to-fuchsia-50/70 border border-purple-100 rounded-[2rem] p-7 sm:p-10 shadow-lg shadow-purple-900/5 space-y-6">
                        ...
                        <div className="grid gap-3.5 sm:grid-cols-2 lg:grid-cols-4">
                            {[
                                ...
                                >
                                    <Gamepad2 className="w-4 h-4 text-fuchsia-600 shrink-0" />
                                    <span>{item}</span>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="relative bg-gradient-to-br from-purple-950 via-fuchsia-950 to-slate-950 border border-purple-800/40 rounded-[2rem] p-7 sm:p-10 shadow-xl text-white space-y-6">
                        <h3 className="text-2xl sm:text-3xl font-extrabold text-white">
                            Why Choose TN Computers?
                        </h3>
                        <p className="text-purple-100/90 text-base sm:text-lg leading-relaxed">
                            We strive to provide clear technical advice, authentic products, and customer-focused support to help you get the best value from your IT investments in Chennai.
                        </p>
                    </div>
                </div>
            )}
            ...
            <div className="text-center pt-4">
                <button
                    ...
                    className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white font-bold text-sm sm:text-base shadow-lg shadow-purple-600/30 hover:shadow-xl hover:shadow-purple-600/40 transition-all duration-300 transform active:scale-95"
                >
