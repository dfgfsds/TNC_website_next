                ...
                <div className="max-w-5xl">
                    ...
                    >
                        ...
                        <p className="text-gray-700 text-lg text-start leading-relaxed">
                            At TN Computers, we pride ourselves on offering a diverse selection of computing products to meet every need:
                        </p>
                        ...
                        <div className="text-gray-700 text-lg text-start space-y-4 leading-relaxed">
                            ...
                            <ul className="list-disc text-start ml-6 mt-4 space-y-1">
                                <li><b>New Laptops and Computers –</b> All major brands available, including Dell, HP, Lenovo, ASUS, Acer, and more.</li>
                                <li><b>Refurbished Laptops and Desktops –</b> Quality-tested systems that deliver performance at affordable prices.</li>
                                <li><b>Custom PC and Laptop Builds –</b> Tailored machines designed for gaming, professional work, or personal use.</li>
                                <li><b>Gaming PCs and Laptops –</b> Powerful, ready-to-use rigs for smooth gameplay and top-tier performance.</li>
                                <li><b>IT Accessories –</b> Keyboards, mice, monitors, storage devices, and more.</li>
                            ...
                            <ul className="list-disc ml-6 space-y-1">
                                ...
                                <li><b>Affordable Prices –</b> We offer refurbished laptops in Chennai and other quality systems at unbeatable rates.</li>
                                ...
                                <li><b>After-Sales Support –</b> Enjoy peace of mind with our dedicated service and support.</li>
                            ...
                            <p>Looking for value without compromise? TN Computers is your go-to for refurbished gaming PC laptops and refurbished laptops in Chennai. Each system is rigorously tested to ensure reliability and performance. Gaming laptops, high-speed desktops, and professional workstations are all available at competitive prices.</p>
...
<p className="mt-3">Step into our laptop showroom in Chennai to explore our full range of products, get expert advice, and see machines in action. From new laptops and custom PC builds to refurbished systems, we provide hands-on experience to help you make the right choice.</p>
                            ...
                            <p>At TN Computers, we combine quality, affordability, and service to ensure every customer leaves satisfied. Whether you’re buying your first laptop, upgrading your gaming setup, or building a custom PC, we are recognized as the best laptop shop in Chennai for good reason.</p>
                            <ul className="list-disc ml-6 space-y-1">
                                <li><b>Laptop Store Chennai –</b> All brands and models available.</li>
                                <li><b>Refurbished Laptops in Chennai –</b> Tested and trusted systems.</li>
                                <li><b>Gaming PC Build Chennai –</b> Powerful machines for serious gamers.</li>
                                <li><b>Custom PC Builder –</b> Tailored solutions to meet your needs.</li>
