...
// ✅ Dynamic Imports for Below-The-Fold Sections to reduce initial JavaScript bundle
const ProductPromoSection = dynamic(
  () => import("./components/ProductPromoSection"),
  { loading: () => <div className="h-48 bg-gray-50 animate-pulse my-4 rounded-lg" /> }
);
const HeroSectionTrustedLap = dynamic(
  () => import("./components/trustedLaptop"),
  { loading: () => <div className="h-48 bg-gray-50 animate-pulse my-4 rounded-lg" /> }
);
const FeatureHighlights = dynamic(
  () => import("./components/FeatureHighlights"),
  { loading: () => <div className="h-32 bg-gray-50 animate-pulse my-4 rounded-lg" /> }
);
...
// ✅ Optimized SSR Data Fetching with Built-in Next.js Caching & Revalidation
async function getHomeData() {
  const vendorId = 66;

  try {
    const fetchOptions: RequestInit = {
      headers: { Origin: "https://tncomputers.in" },
      next: { revalidate: 300 }, // Caches response for 5 minutes (ISR)
    };

    const [bannerRes, categoryRes, productRes] = await Promise.all([
      fetch(`${baseUrl}/banners/?vendorId=${vendorId}`, fetchOptions),
      fetch(`${baseUrl}/api/categories/?vendor_id=${vendorId}`, fetchOptions),
      fetch(`${baseUrl}/api/products/?vendor_id=${vendorId}`, fetchOptions),
    ]);
    ...
    return {
      ...
      products: productData?.data || productData || [],
    };
  } catch (error) {
  ...
  const homeJsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "Computer Shop in Chennai | Laptops, PCs & Gaming | TN Computers",
        description:
          "TN Computers offers laptops, desktop computers, gaming PCs, custom PC builds, refurbished laptops, PC components, gaming accessories and computer services in Chennai.",
        isPartOf: {
          "@id": "https://www.tncomputers.in/#website",
        },
        about: {
        ...
        itemListElement: [
          {
            ...
            item: {
              ...
              reviewBody:
                "Got my PC built at TN Computers and I’m very happy with the performance. The staff were friendly, explained everything clearly, and guided me throughout the purchase. Overall, the experience was smooth and satisfying.",
              itemReviewed: {
                "@id": "https://www.tncomputers.in/#localbusiness",
              },
            },
          },
          {
            ...
            item: {
              ...
              reviewBody:
                "I purchased an Acer Aspire 3 laptop from TN Computers at a very affordable price. The customer handling was really good, and I’m completely satisfied with the service.",
              itemReviewed: {
                "@id": "https://www.tncomputers.in/#localbusiness",
              },
            },
          },
          {
            ...
            item: {
              ...
              reviewBody:
                "I bought a brand-new Lenovo laptop from TN Computers and was really impressed with the pricing. The team provided good customer service and made the overall buying experience easy and comfortable.",
              itemReviewed: {
                "@id": "https://www.tncomputers.in/#localbusiness",
              },
            },
          },
          {
            ...
            item: {
              ...
              reviewBody:
                "I bought a new gaming PC and was very happy with the product and the suggestions provided by the team. The PC quality was better than I expected for my budget. Very satisfied with the overall experience.",
              itemReviewed: {
                "@id": "https://www.tncomputers.in/#localbusiness",
              },
            },
          },
          {
            ...
            item: {
              ...
              reviewBody:
                "The staff were knowledgeable, friendly, and patient. They explained the differences between laptop models clearly and answered all my questions without rushing me into a decision.",
              itemReviewed: {
                "@id": "https://www.tncomputers.in/#localbusiness",
              },
            },
          },
          {
            ...
            item: {
              ...
              reviewBody:
                "I purchased a PC from TN Computers and was satisfied with the affordable pricing, product quality, and service. The staff had good hardware knowledge and provided helpful guidance throughout the purchase.",
              itemReviewed: {
                "@id": "https://www.tncomputers.in/#localbusiness",
              },
            },
