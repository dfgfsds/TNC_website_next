    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold mb-4 mt-3">Computer Categories – Laptops, PC Parts & Accessories </h1>
          <h2 className="text-muted-foreground max-w-2xl mx-auto">
            Explore laptops, desktops, PC components and accessories at TN Computers, Chennai.
          </h2>
        </div>
